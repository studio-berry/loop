...
| --- | --- | --- | --- |
| Document | Open, view, navigate, save/export, and ordinary PDF interaction | `LoopEditor`, `LoopLibQuick`, shared document/session contracts | A separate Viewer product or a second document model |
