...
|------|----------------|----------|-------|-------|
| Processing budgets | `PDFProcessingBudget` bounds decode, raster, and graph work; JBIG2 rejects streams with more than 256 empty symbol-dictionary height classes | No equivalent named pools | `UnitTestsProcessingBudget`, `UnitTestsBudgetExhaustion`, `fuzz_images` corpus | #242 / #243 / #64 |
