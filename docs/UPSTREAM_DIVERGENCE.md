...
|------|----------------|----------|-------|-------|
| Processing budgets | `PDFProcessingBudget` bounds decode, raster, and graph work; JBIG2 bounds consecutive empty symbol-dictionary export-flag runs | No equivalent named pools | `UnitTestsProcessingBudget`, `UnitTestsBudgetExhaustion`, `fuzz_images` corpus | #242 / #243 / #64 |
