...
Product: **Loupe PDF 0.2.0-alpha** (Qt6 desktop PDF toolkit)
...
**After sign-off (step 6, out of scope for this pass):** dispatch `CreateReleaseDraft.yml` on the release SHA, publish `v0.2.0-alpha`, attach MSI + AppImage + `SHA256SUMS.txt`.
