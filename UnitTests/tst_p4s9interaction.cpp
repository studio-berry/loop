...
using loupe::interaction::InspectorModel;
using loupe::interaction::PagesModel;
using loupe::interaction::PageView;
using loupe::interaction::PreviewStateModel;
using loupe::interaction::ProductionModel;
...
{
    loupe::interaction::PreflightFindingsModel findings;
