...
if(NOT LOUPE_BUILD_ONLY_CORE_LIBRARY)
    ...
    if(LOUPE_BUILD_QUICK_CANVAS)
        ...
        target_link_libraries(UnitTestsQuickDocumentModel PRIVATE LoupeEditorQuick LoupeLibCore Qt6::Core Qt6::Gui Qt6::Qml Qt6::Quick Qt6::Test)
        ...
        add_test(UnitTestsQuickDocumentModel "${CMAKE_BINARY_DIR}/${LOUPE_INSTALL_BIN_DIR}/UnitTestsQuickDocumentModel")
