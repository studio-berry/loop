#!/usr/bin/env python3
"""Negative coverage for scripts/verify-loop-shell-contract.ps1."""
...
VERIFIER_PS1 = ROOT / "scripts" / "verify-loop-shell-contract.ps1"
VERIFIER_PY = ROOT / "scripts" / "verify-loop-shell-contract.py"
...
class VerifyLoopShellContractTest(unittest.TestCase):
    def setUp(self) -> None:
