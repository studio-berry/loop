...
class WorkflowContractTests(unittest.TestCase):
    ...
    def test_package_workflows_require_and_record_exact_source_sha(self):
        ...
        self.assertIn("build\\LoupeEditor\\Loupe\\Quick", windows)
        self.assertIn("plugins/sqldrivers", linux)
        self.assertIn("build/LoupeEditor/Loupe/Quick", linux)
        self.assertIn('-qmldir="$GITHUB_WORKSPACE/loupe/LoupeEditor/qml"', linux)
